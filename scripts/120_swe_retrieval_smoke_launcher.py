#!/usr/bin/env python3
"""External deadline for the 117-selected policy through the 118 smoke wrapper."""
...
OUT = ROOT / "runs/swe-diversity-selection/swe-sympy-retrieval-policies/learner_smoke"
...
def main():
    ...
    assert auth["smoke_script_sha256"] == sha(ROOT / "scripts/118_swe_retrieval_policy_smoke.py")
    ...
    cmd = [str(ROOT / ".venv/bin/python"), str(ROOT / "scripts/118_swe_retrieval_policy_smoke.py"), "run"]
    save(
