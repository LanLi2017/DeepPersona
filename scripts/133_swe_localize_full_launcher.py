#!/usr/bin/env python3
"""One absolute remaining-budget deadline for the132 full learner control."""
...
OUT = ROOT / "runs/swe-diversity-selection/swe-localize-repair-support/full_training"
...
def main():
    ...
    assert auth["training_script_sha256"] == sha(ROOT / "scripts/132_swe_localize_full_train.py")
    ...
    cmd = [str(ROOT / ".venv/bin/python"), str(ROOT / "scripts/132_swe_localize_full_train.py"), "run"]
    save(
