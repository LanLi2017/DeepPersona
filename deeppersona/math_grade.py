...
Vendored verbatim from E-SPL:
refs/E-SPL/tinker_cookbook/recipes/math_rl/math_grading.py
Used for MATH scoring (extract_boxed + grade_answer under run_with_timeout_signal).
grade_answer_math_verify imports math_verify lazily (not installed by default).
"""
